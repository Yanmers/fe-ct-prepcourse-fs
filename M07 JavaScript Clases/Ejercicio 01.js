...
function crearUsuario() {
   ...
   let Yaniel = new Usuario( 'yaniel', 'david', '@yanielDavid', 12345);
   Yaniel.saludar();
   return Usuario;
...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function () {
      ...
      var palabraSepara = this.split('');

      for (let i = palabraSepara.length -1; i >= 0; i--) {
         palabraSeparadaInvertida.push(palabraSepara[i]);
      }
